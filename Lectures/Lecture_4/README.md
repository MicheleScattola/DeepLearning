...
1. Download the data with:
    ```
    wget https://raw.githubusercontent.com/scarrazza/DL2026/main/Lecture_4/data.dat
    # or (on OSX)
    curl https://raw.githubusercontent.com/scarrazza/DL2026/main/Lecture_4/data.dat -o data.dat
    ```
